...
sns.regplot(x='totall_bill', y='tip', data=tips, color='blue', scatter_kws={'s': 50, 'alpha': 0.5}, line_kws={'linestyle': '--'}, ax=ax1)
...
sns.histplot(tips['tip'], bins=30, kde=True, color='skybule')
...
plt.suptitle('Pairplot with Histograms by Gender', y=1.85)